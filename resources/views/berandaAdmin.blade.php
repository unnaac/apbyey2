...
<body class="bg-gradient-to-br from-slate-50 to-slate-200 min-h-screen text-gray-900 font-inter">
                ...
                <div class="lg:col-span-9 space-y-6">
                    ...
                    <section class="animate-slide-up">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 stagger-animation">
                            <div class="glass-effect rounded-xl p-6 shadow-[0_4px_20px_rgba(0,0,0,0.08)] stat-card card-hover cursor-pointer" onclick="ambilStatistikLaporan()">
                                ...
                                <div class="text-left" id="total-reports">
                            ...
                            <div class="glass-effect rounded-xl p-6 shadow-[0_4px_20px_rgba(0,0,0,0.08)] stat-card card-hover cursor-pointer" onclick="showDetails('created-reports')">
                                ...
                                <div class="text-left" id="created-reports">
                            ...
                            <div class="glass-effect rounded-xl p-6 shadow-[0_4px_20px_rgba(0,0,0,0.08)] stat-card card-hover cursor-pointer" onclick="showDetails('processing-reports')">
                                ...
                                <div class="text-left" id="processing-reports">
                            ...
                            <div class="glass-effect rounded-xl p-6 shadow-[0_4px_20px_rgba(0,0,0,0.08)] stat-card card-hover cursor-pointer" onclick="showDetails('completed-reports')">
                                ...
                                <div class="text-left" id="completed-reports">
                    ...
                    <section class="animate-slide-up">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 stagger-animation">
                            <div class="glass-effect rounded-xl p-6 shadow-[0_4px_20px_rgba(0,0,0,0.08)] stat-card card-hover cursor-pointer" onclick="hitungStatistikKonseling()">
                                <div class="flex items-center justify-between mb-4">
                                    <div class="bg-gradient-to-br from-red-100 to-red-200 p-3 rounded-xl">
                                        <i class="fas fa-users text-telusafe-red text-xl"></i>
                                    </div>
                                </div>
                                <div class="text-left" id="counseling-students">
                            ...
                            <div class="glass-effect rounded-xl p-6 shadow-[0_4px_20px_rgba(0,0,0,0.08)] stat-card card-hover cursor-pointer" onclick="showDetails('psychologists')">
                                ...
                                <div class="text-left" id="psychologists-count">
                            ...
                            <div class="glass-effect rounded-xl p-6 shadow-[0_4px_20px_rgba(0,0,0,0.08)] stat-card card-hover cursor-pointer" onclick="showDetails('new-counseling')">
                                ...
                                <div class="text-left" id="new-counseling-count">
                                    <p class="text-[32px] font-bold font-poppins text-gray-800 counter" data-count="5">0</p>
                            ...
                            <div class="glass-effect rounded-xl p-6 shadow-[0_4px_20px_rgba(0,0,0,0.08)] stat-card card-hover cursor-pointer" onclick="showDetails('follow-up-counseling')">
                                ...
                                <div class="text-left" id="follow-up-counseling-count">
                                    <p class="text-[32px] font-bold font-poppins text-gray-800 counter" data-count="8">0</p>
                    ...
                    <section class="animate-slide-up">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 stagger-animation">
                            <div class="glass-effect rounded-xl p-6 shadow-[0_4px_20px_rgba(0,0,0,0.08)] stat-card card-hover cursor-pointer" onclick="fetchEmosikuStats()">
                                <div class="flex items-center justify-between mb-4">
                                    <div class="bg-gradient-to-br from-red-100 to-red-200 p-3 rounded-xl">
                                        <i class="fas fa-graduation-cap text-telusafe-red text-xl"></i>
                                    </div>
                                </div>
                                <div class="text-left" id="total-students">
                                    <p class="text-[32px] font-bold font-poppins text-gray-800 counter" data-count="1000">0</p>
                            ...
                            <div class="glass-effect rounded-xl p-6 shadow-[0_4px_20px_rgba(0,0,0,0.08)] stat-card card-hover cursor-pointer" onclick="showDetails('special-attention')">
                                ...
                                <div class="text-left" id="special-attention-count">
                                    <p class="text-[32px] font-bold font-poppins text-gray-800 counter" data-count="300">0</p>
                            ...
                            <div class="glass-effect rounded-xl p-6 shadow-[0_4px_20px_rgba(0,0,0,0.08)] stat-card card-hover cursor-pointer" onclick="showDetails('help-sent')">
                                ...
                                <div class="text-left" id="help-sent-count">
                                    <p class="text-[32px] font-bold font-poppins text-gray-800 counter" data-count="5">0</p>
                            ...
                            <div class="glass-effect rounded-xl p-6 shadow-[0_4px_20px_rgba(0,0,0,0.08)] stat-card card-hover cursor-pointer" onclick="showDetails('emotion-trends')">
                                ...
                                <div class="text-left" id="emotion-trends-count">
                                    <p class="text-[32px] font-bold font-poppins text-gray-800 counter" data-count="8">0</p>
    ...
    // Logout dari Firebase
        ...
        function ambilStatistikLaporan() {
            ...
            laporanRef.once('value')
                ...
                const counterE1 = document.querySelector('#total-reports .counter');
                if (counterE1) {
                    counterE1.textContent = totalLaporan;
                    counterE1.setAttribute('data-count', totalLaporan);
                }
                const counterE2 = document.querySelector('#created-reports .counter');
                if (counterE2) {
                    counterE2.textContent = laporanHariIni;
                    counterE2.setAttribute('data-count', laporanHariIni);
                }

                const counterE3 = document.querySelector('#processing-reports .counter');
                if (counterE3) {
                    counterE3.textContent = prosesUdah;
                    counterE3.setAttribute('data-count', prosesUdah);
                }
                const counterE4 = document.querySelector('#completed-reports .counter');
                if (counterE4) {
    ...
    // Ambil data konseling terlebih dahulu
    konselingRef.once('value', (snapshot) => {
        ...
        Object.values(data).forEach(item => {
            if (item.userId) {
                mahasiswaSet.add(item.userId); // Mahasiswa unik
            }
        ...
        // Update jumlah mahasiswa konseling
        ...
        // Update jumlah kunjungan lanjut
    ...
    // Ambil data user untuk hitung psikolog
    usersRef.once('value', (snapshot) => {
        const usersData = snapshot.val();
        if (!usersData) return;

        let jumlahPsikolog = 0;
        Object.values(usersData).forEach(user => {
            if (user.status && user.status.toLowerCase() === 'psikolog') {
                jumlahPsikolog++;
            }
        });

        // Update jumlah psikolog
        const psikologCounter = document.querySelector('#psychologists-count .counter');
        if (psikologCounter) {
            psikologCounter.textContent = jumlahPsikolog;
            psikologCounter.setAttribute('data-count', jumlahPsikolog);
        }
    });
}

        function fetchEmosikuStats() {
    const emosikuRef = firebase.database().ref('emosiku');

    emosikuRef.once('value', (snapshot) => {
        const data = snapshot.val();
        if (!data) return;

        const mahasiswaSet = new Set(); // Untuk jumlah mahasiswa
        let bantuanYaCount = 0;
        let totalMood = 0;
        ...
        let konsistenSedihCount = 0;

        Object.entries(data).forEach(([userId, tanggalData]) => {
            mahasiswaSet.add(userId);

            // Untuk konsisten 3 hari very_dissatisfied
            const tanggalList = Object.entries(tanggalData)
                .map(([tgl, val]) => ({ tgl, mood: val.mood }))
                .filter(entry => entry.mood === 'very_dissatisfied')
                .map(entry => entry.tgl)
                .sort((a, b) => {
            ...
            // Cek 3 hari berturut-turut very_dissatisfied
            for (let i = 0; i < tanggalList.length - 2; i++) {
                const d1 = toDate(tanggalList[i]);
                const d2 = toDate(tanggalList[i + 1]);
                const d3 = toDate(tanggalList[i + 2]);

                if (isConsecutiveDays(d1, d2) && isConsecutiveDays(d2, d3)) {
                    konsistenSedihCount++;
                    break;
                }
            }

            Object.values(tanggalData).forEach((entry) => {
                if (entry.bantuan && entry.bantuan.toLowerCase() === 'ya') {
                    bantuanYaCount++;
                }

                if (entry.mood && moodMap[entry.mood] !== undefined) {
                    totalMood += moodMap[entry.mood];
                    totalMoodEntries++;
                }
            });
        });

        const avgMood = totalMoodEntries > 0 ? (totalMood / totalMoodEntries).toFixed(2) : 0;

        // Update ke tampilan

        
        
        console.log('Jumlah Mahasiswa:', mahasiswaSet.size);
        console.log('Mahasiswa 3 Hari Berturut Mood Very Dissatisfied:', konsistenSedihCount);
        console.log('Jumlah Bantuan = "ya":', bantuanYaCount);
        console.log('Rata-rata Mood:', avgMood);

        const counselingStudentsCounter = document.querySelector('#total-students .counter');
if (counselingStudentsCounter) {
    counselingStudentsCounter.textContent = mahasiswaSet.size;
    counselingStudentsCounter.setAttribute('data-count', mahasiswaSet.size);
}

const specialAttentionCounter = document.querySelector('#special-attention-count .counter');
if (specialAttentionCounter) {
    specialAttentionCounter.textContent = konsistenSedihCount;
    specialAttentionCounter.setAttribute('data-count', konsistenSedihCount);
}

const helpSentCounter = document.querySelector('#help-sent-count .counter');
if (helpSentCounter) {
    helpSentCounter.textContent = bantuanYaCount;
    helpSentCounter.setAttribute('data-count', bantuanYaCount);
}

const emotionTrendsCounter = document.querySelector('#emotion-trends-count .counter');
if (emotionTrendsCounter) {
    // Rata-rata mood biasanya desimal, bisa dibulatkan 2 angka
    emotionTrendsCounter.textContent = avgMood;
    emotionTrendsCounter.setAttribute('data-count', avgMood);
}
...
function updateCounter(selector, value) {
    const el = document.querySelector(`${selector} .counter`);
    if (el) {
